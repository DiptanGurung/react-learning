...
function Container() {
  return (
<>
<div className='text-black text-xl font-bold bg-red-400 w-full h-[100vh]  flex flex-col'>
  <h1 className='flex justify-center'>PRACTICE</h1>
    <div className='text-black text-xl w-full h-[300px] flex justify-around'>
        ...
        <div className='text-black text-xl w-[500px] flex flex-col justify-center items-center'>
